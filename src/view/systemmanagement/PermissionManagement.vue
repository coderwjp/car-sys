        ...
        <div class="container">
            <div class="handle-box">
                <el-select v-model="query.address" placeholder="类别" class="handle-select mr10">
                    <el-option key="1" label="菜单级" value="菜单级"></el-option>
                    <el-option key="2" label="菜单级" value="菜单级"></el-option>
                </el-select>
            ...
            >
                ...
                <el-table-column prop="address" label="权限值"></el-table-column>
                <el-table-column prop="address" label="权限类别"></el-table-column>
